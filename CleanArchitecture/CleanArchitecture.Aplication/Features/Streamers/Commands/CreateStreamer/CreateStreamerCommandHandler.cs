...
namespace CleanArchitecture.Aplication.Features.Streamers.Commands.CreateStreamer
{
    public class CreateStreamerCommandHandler : IRequestHandler<CreateStreamerCommand, int>
    {
        ...
        private async Task SendEmail(Streamer streamer)
        {
            ...
            {
                _logger.LogError($"Errores enviendo el email de {streamer.Id}");
            }
        }
